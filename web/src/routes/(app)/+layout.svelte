				...
				<div class="container-xl">
					...
					<div class="navbar-nav flex-row order-md-last">
						...
						<div class="d-none d-md-flex cursor-pointer">
							<a onclick={preventDefault(toggleTheme)} class="nav-link px-0">
					...
					<div class="collapse navbar-collapse" id="navbar-menu">
						...
						>
							<ul class="navbar-nav">
								<li class="nav-item">
									<a class="nav-link" href="/" onclick={navigate('/')}>
								...
								<li class="nav-item">
									<a href="/vulnerability" class="nav-link" onclick={navigate('/vulnerability')}>
										<span class="nav-link-icon d-md-none d-lg-inline-block">
											<svg
												xmlns="http://www.w3.org/2000/svg"
								...
								<li class="nav-item">
									<a href="/project" class="nav-link" onclick={navigate('/project')}>
										<span class="nav-link-icon d-md-none d-lg-inline-block">
											<svg
												xmlns="http://www.w3.org/2000/svg"
								...
								{#if $accessLevels['/report']}
									<li class="nav-item">
										<a href="/report" class="nav-link" onclick={navigate('/report')}>
											<span class="nav-link-icon d-md-none d-lg-inline-block">
												<svg
													xmlns="http://www.w3.org/2000/svg"
								...
								<li class="nav-item">
									<a href="/notes" class="nav-link" onclick={navigate('/notes')}>
										<span class="nav-link-icon d-md-none d-lg-inline-block">
											<svg
												xmlns="http://www.w3.org/2000/svg"
										...
										<span class="nav-link-title"> Notes </span>
									</a>
								</li>

								{#if $accessLevels['/planning']}
									<li class="nav-item">
										<a href="/planning" class="nav-link" onclick={navigate('/planning')}>
											<span class="nav-link-icon d-md-none d-lg-inline-block">
												<svg
													xmlns="http://www.w3.org/2000/svg"
