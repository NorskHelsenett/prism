				...
				<div class="container-tight">
					...
					<div class="card card-md">
						<div class="card-body">
							...
							<!-- <div class="row">
								<a href="{endpoint}/api/login" type="submit" class="col btn btn-primary w-100 disabled">
									<svg
							...
							<div class="row">
								<a href="{endpoint}/api/login" type="submit" class="col btn btn-warning w-100">
