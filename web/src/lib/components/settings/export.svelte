...
<div class="card-body">
  ...
  <p class="text-secondary">Export the entire database file. Importing this file will overwrite any existing database file and terminate any active connections. All users will be <strong>logged out.</strong> Please exercise <strong >CAUTION</strong> when using this option. <span class="text-yellow bg-transparent"> The server will perform a hard restart after the import.</span></p>
