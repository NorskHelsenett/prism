				...
				<div class="nav-item dropdown">
					<a href="#" class="nav-link d-flex lh-1 text-reset p-0">
						<span
							...
							style="background-image: url(https://1.gravatar.com/avatar/2ab5dfe3c36120df438583f9e40f024251d0c0752544cf35af62895ebbd82dc9?size=256)"
						></span>
						<div class="d-none d-xl-block ps-2">
							<div>Jonas Bo Grimsgaard</div>
